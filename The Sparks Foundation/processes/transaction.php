...
<body>
    ...
    <div id="box">
        <h3 id="customer">Enter Details</h3>
        <span id="error" style="color:red"></span><br>
        <span>Payer Account Number : </span>
        <input id="name1" type="number" placeholder="Enter your account no." required autocomplete="off"><br><br>
        <span>Payee Account Number : </span>
        <input id="name2" type="number" value="<?php echo $account; ?>" placeholder="Enter payee account no."><br><br>
        <span>Amount : </span>
        <input id="name3" type="number" placeholder="Amount" required autocomplete="off"><br><br>
        <button onclick="checkIntoDatabase()" id="submitBtn">Send</button>
    </div>
    
    
    <form method="post" action="./transactionDetails.php" id="id0" style="display: none;">
        <input type="number" id="id1" name="action1" value=''>
        <input type="number" id="id2" name="action2" value=''>
        <input type="number" id="id3" name="action3" value=''>
    </form>
    <div id="wrapper">
    ...
    <script type="text/javascript">
        ...
        function checkIntoDatabase() {
            payer_acc = document.getElementById('name1').value;
            payee_acc = document.getElementById('name2').value;
            balance = document.getElementById('name3').value;
            ...
            $.ajax({
                ...
                success: function getdata(result) {
                    if (result != "right") {
                        ...
                        document.getElementById('id1').value = payer_acc;
                        document.getElementById('id2').value = payee_acc;
                        document.getElementById('id3').value = balance;
                        document.getElementById('id0').submit();
